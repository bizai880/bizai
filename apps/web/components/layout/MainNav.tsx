...
export default function MainNav() {
  ...
  const navItems = [
    { href: '/dashboard', label: 'لوحة التحكم', icon: <LayoutDashboard className="w-4 h-4" /> },
    { href: '/dashboard/users', label: 'المستخدمين', icon: <Users className="w-4 h-4" /> },
    { href: '/dashboard/settings', label: 'الإعدادات', icon: <Settings className="w-4 h-4" /> },
  ]
