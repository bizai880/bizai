...
export const metadata: Metadata = {
  ...
  description: 'منصة واحدة تجمع بين قوة الذكاء الاصطناعي المعياري وسهولة بناء أنظمة الأعمال',
  keywords: ['ذكاء اصطناعي', 'أنظمة أعمال', 'مكعبات ذكية', 'Excel', 'تحليلات', 'BizAI'],
