		...
		<div className="container mx-auto p-6 space-y-6">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>أدخل بيانات اختبارية للمكعب</CardDescription>
							</CardHeader>
							<CardContent className="space-y-4">
								<div className="space-y-2">
							...
							<CardContent>
								{testResult ? (
									<div className="space-y-4">
										...
										{testResult.error && (
											<div>
												<Label className="mb-2 block text-red-600 dark:text-red-400">
													الخطأ:
												</Label>
									...
									<div className="text-center py-8 text-gray-500">
										...
										<p className="text-sm mt-2">
											أدخل بيانات الاختبار واضغط على "تشغيل الاختبار"
										</p>
									</div>
								)}
							</CardContent>
							...
							{selectedCube ? (
								<div className="space-y-4">
									...
									<div className="flex justify-end space-x-3 pt-4">
										<Button
											variant="outline"
											onClick={() => toast.info("تم حفظ المسودة")}
										>
			...
			<Card className="mt-6">
				<CardHeader>
					...
					<CardDescription>ابدأ بإنشاء مكعب ذكي جديد</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4">
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<div className="space-y-2">
						...
						<div className="space-y-2">
							...
							<Select
								value={cubeCategory}
								onValueChange={(value: CubeCategory) => setCubeCategory(value)}
							>
								<SelectTrigger>
							...
							{cubeTags.map((tag) => (
								...
								>
									...
									<button
										type="button"
										onClick={() =>
											setCubeTags(cubeTags.filter((t) => t !== tag))
										}
