    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-background-dark p-4 md:p-8">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="glass-card p-4">
          <h3 className="text-lg font-semibold text-text-primary">إجمالي المستخدمين</h3>
          <p className="text-3xl font-bold text-primary mt-2">1,847</p>
        </div>
        <div className="glass-card p-4">
          <h3 className="text-lg font-semibold text-text-primary">النشاط اليومي</h3>
          <p className="text-3xl font-bold text-green-500 mt-2">+12.5%</p>
        </div>
        <div className="glass-card p-4">
          <h3 className="text-lg font-semibold text-text-primary">المهام المكتملة</h3>
          <p className="text-3xl font-bold text-purple-500 mt-2">89%</p>
        </div>
        <div className="glass-card p-4">
          <h3 className="text-lg font-semibold text-text-primary">وقت التشغيل</h3>
